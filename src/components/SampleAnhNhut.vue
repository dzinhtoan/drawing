...
`;
    ...
    const initWidth = computed(() => windowWidth.value);
    const initHeight = computed(() => windowHeight.value);


    const camera = new THREE.PerspectiveCamera(45, initWidth.value / initHeight.value, 0.1, 1000);
